...
[Sito Web](https://www.unibo.it/sitoweb/riccardo.amorati)
 * Tesi proposte
   - Tutte
     + <p>Le tesi proposte sono nell'ambito dell chimica degli <strong>antiossidanti</strong> e dell'ossidazione degli oli. Gli argomenti trattati hanno applicazioni in ambito farmaceutico, cosmetico ed alimentare. L'insegnamento corrispondente è la Chimica Organica.</p><p><a href="https://www.dropbox.com/s/4cmgp5i0619mx1j/Tesi%20presentazione%20Amorati%202019.pdf?dl=0">Argomenti disponibili:</a></p><p>1) Studio dell'attività antiossidante di <strong>molecole naturali</strong> o sintetiche.</p><p>2) Nanoantiossidanti: sintesi e analisi di <strong>nanoparticelle</strong> con attività antiossidante.</p><p>3) Sviluppo di <strong>nuovi metodi</strong> per misurare l'attività antiossidante in sistemi biomimetici.</p><p>4) Ossidazione di oli ad <strong>alta temperatura</strong>&nbsp;(ex. condizioni di frittura).</p><p><strong><span style="text-decoration: underline;">Possibilità di tesi all'estero</span></strong> (prof. Grzegorz Litwinienko, <a href="http://en.uw.edu.pl/">Università di Varsavia</a>).</p><p>&nbsp;</p><p>&nbsp;</p>
 * Tesi assegnate

#### Catia Arbizzani
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/catia.arbizzani)
 * Tesi proposte
   - Tutte
     + <p><a href="http://www.chimica.unibo.it/it/risorse/files/tesi/1xarbizzanisoavi">http://www.chimica.unibo.it/it/risorse/files/tesi/1xarbizzanisoavi</a></p><p><a href="http://www.chimica.unibo.it/it/risorse/files/tesi/1xarbizzani">http://www.chimica.unibo.it/it/risorse/files/tesi/1xarbizzani</a></p>
 * Tesi assegnate
   - Tesi di Laurea
     + Analisi delle caratteristiche dei materiali elettrodici per le batterie sodio-ione e studio della loro applicazione con soluzioni elettrolitiche acquose.
     + Caratterizzazione di materiali per elettrodi positivi in una batteria redox a flusso a base di rame
     + Cattura della CO2 e strategie per il suo riutilizzo
     + Confronto delle prestazioni di separatori polimerici per batterie di nuova generazione.
     + Elettrodi preparati con leganti solubili in acqua per celle funzionanti in mezzo acquoso: una nuova sfida per la sostenibilità
     + Elettroliti solidi per batterie innovative: progressi e prospettive
     + Graphitic carbon from CO2 for sustainable Li ion battery anodes
     + Ingegneria delle interfasi per batterie al litio ad alte prestazioni
     + Sistemi bioelettrochimici per applicazioni sostenibili: stato dell'arte, scale up e sviluppi futuri
     + Sistemi elettrolitici per dispositivi elettrochimici di accumulo e conversione di energia
     + Studio e sviluppo di anodi per celle sodio-ione
     + Sviluppi e applicazioni di materiali autoriparanti e batterie autoriparabili
   - Tesi di Laurea Magistrale
     + Caratterizzazione spettroelettrochimica di cloro-complessi di rame in soluzioni elettrolitiche per celle redox a flusso
     + Electrochemical investigation of components for Copper based Redox Flow Cells.
     + Experimental validation of a novel electrochemical dilatometer for testing metal-ion batteries
     + Study of lithium metal - solid electrolyte interphase
   - Tesi di Dottorato
...
#### Daniele Fazzi
###### Ricercatore a tempo determinato tipo b) (senior)
[Sito Web](https://www.unibo.it/sitoweb/daniele.fazzi)
 * Tesi proposte
 * Tesi assegnate
 ...
 * Tesi assegnate
   - Tesi di Laurea Magistrale
     ...
     + Morphological tuning of silica biomorphs using proteins and amino acids
     + Studio strutturale della NAD(P)H chinone ossidoreduttasi da Arabidopsis thaliana e applicazione dell'enzima nella preparazione di film biopolimerici per uso cosmetico.

#### Andrea Fermi
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/andrea.fermi2)
 * Tesi proposte
 * Tesi assegnate
 ...
 * Tesi assegnate
   ...
   - Tesi di Laurea Magistrale
     + Development and validation of analytical methods for the analysis of corticosteroids in counterfeit cosmetic products
     + hydroxyapatate and its applications incosmetic
     + la spettrometria di massa applicata all’analisi di metaboliti fecali e proteine allergeniche
     + Optimization of a Depilatory Cream

#### Maria Letizia Focarete
###### Professoressa ordinaria
[Sito Web](https://www.unibo.it/sitoweb/marialetizia.focarete)
 * Tesi proposte
   - Tutte
     + <p><strong>Biomateriali Polimerici</strong> (T,M)</p><p><a href="http://www.chimica.unibo.it/it/risorse/files/tesi/1xfocaretegualandi">Link al pdf</a></p><p><strong>Materiali Polimerici Funzionali</strong> (T,M)&nbsp;</p><p><a href="http://www.chimica.unibo.it/it/risorse/files/tesi/2xfocaretegualandi">Link al pdf</a></p><p><strong style="font-size: 12.8px;">Rilascio controllato di nanomateriali da nanofibre polimeriche biocompatibili per applicazioni biomediche</strong><span style="font-size: 12.8px;"> (M)</span><br></p><p><a href="http://www.chimica.unibo.it/it/attivita-didattica/risorse/files/tesi/1xzaccheronifocarete">Link al pdf</a></p><p>&nbsp;</p>
 * Tesi assegnate
   - Tesi di Laurea
     + "studio di materiali polimerici per packaging sostenibile"
     + Antibacterial Silver Nanoparticles-Coated Poly(L-Lactide) Electrospun Fibers
     + Carbon dots embedded poly(lactic acid) electrospun membranes for oil spills cleanup
     + Fabrication of Titanium nanotubes using sacrificial polymer nanofibers
     + Materiali ibridi costituiti da nanofibre e nanoparticelle per applicazioni mediche
     + Progettazione e sviluppo di coating di argento antibatterici su nanofibre polimeriche
...
#### Susanna Guernelli
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/susanna.guernelli)
 * Tesi proposte
   - Tutte
     + <p>Principi attivi vegetali veicolati in nanospugne</p><p>Antiossidanti in sistemi polimerici</p><p>&nbsp;</p>
 * Tesi assegnate
   - Tesi di Laurea
     + Analisi dell'efficacia delle Piretrine caricate in nanotubi di allosite
   - Tesi di Laurea Magistrale a ciclo unico
     + Valutazione dell'attività antiossidante di nano formulazioni
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Studio di nuove vie di sintesi di Beta-Omoproline
   - Tesi di Laurea Magistrale
     ...
     + Nuove vie di sintesi di pirrolidine chirali
     + Sintesi e valutazione biologica di nuovi complessi di Rutenio(II) e Iridio(III) con potenziale attività antitumorale promossa dal legame alogeno
     + Studio di Metodi Sintetici Alternativi per la Preparazione di b-Omoproline
...
#### Massimo Marcaccio
###### Professore ordinario
[Sito Web](https://www.unibo.it/sitoweb/massimo.marcaccio)
 * Tesi proposte
 * Tesi assegnate

#### Assimo Maris
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/assimo.maris)
 * Tesi proposte
   - Tutte
     + <ul>    <li>Sviluppo di modelli di determinazione quantitativa di componenti in prodotti tramite applicazione di tecniche chemiometriche e di calcolo quantomeccanico a dati di spettroscopia nel vicino infrarosso (in collaborazione con BASF).</li>    <li>Analisi di spettri rotazionali per la rivelazione di molecole di interesse atmosferico e astrofisico.</li>    <li>Simulazione quanto-meccanica e assegnazione di spettri di molecole isolate e in fase condensata.</li>    <li>Studio dello spazio conformazionale di molecole flessibili.</li>    <li>Caratterizzazione delle interazioni non-covalenti tramite metodi computazionali e spettroscopici.</li></ul><p>Per una più specifica definizione dei progetti di tesi, rivolgersi direttamente alla docente.&nbsp;</p><p>Gli studenti che entrano in tesi, lavorano a stretto contatto con i componenti del gruppo ricerca (<a href="https://site.unibo.it/freejet/en">https://site.unibo.it/freejet/en</a>) e, dopo un iniziale periodo di inserimento, definiscono congiuntamente gli argomenti più interessanti per il progetto di tesi.</p><p><strong>&nbsp;</strong></p><p><strong>Tesi seguite dal docente</strong></p><ul>    <li>Spettro rotazionale e analisi conformazionale del complesso molecolare debolmente legato N,N-dietilidrossilamina·acqua. </li>    <li>Synthesys and spectroscopic and computational study of NOR compounds. </li>    <li>Spettro rotazionale della N,N’-dimetilurea e analisi conformazionale <em>ab initio</em> delle forme: isolata, dimero e monoidrata. </li>    <li>Caratterizzazione delle forme mono- e bi-idrate dell'acrilamide tramite calcoli quantomeccanici e assegnazione dellospettro CP-FTMW.</li>    <li>Studio dei moti a larga ampiezza della metacrilamide tramite spettroscopia rotazionale in espansione supersonica. </li>    <li>Analisi conformazionale dell’1-otten-3-ol tramite spettroscopia rotazionale e metodi computazionali. </li>    <li>Struttura delle molecole aromatiche: modellizzazione e spettroscopia dell’eugenolo. </li>    <li>Registrazione e analisi dello spettro rotazionale del g’GG 2-(metilamino)etanolo e dei suoi isotopologhi. </li>    <li>Studio della superficie di energia conformazionale dell’1,3-propanditiolo tramite spettroscopia rotazionale e calcoli quanto-meccanici. </li>    <li>Moti interni a larga ampiezza in anelli a 5 termini: spettroscopia rotazionale e modellizzazione di composti imidazolidonici. </li>    <li>Flexible molecule of astrochemical interest: free-jet rotational spectrum of 1,2-butanediol. </li>    <li>Studio di composti pirrolidonici tramite spettroscopia a microonde in espansione supersonica e calcoli quantomeccanici. </li>    <li>Studio di composti eterociclici tramite docking molecolare e spettroscopia rotazionale. </li>    <li>Spettroscopia rotazionale in espansione supersonica: studio del dimero dell’acido acrilico. </li></ul>
 * Tesi assegnate
   - Tesi di Laurea
     + Spettro rotazionale e analisi conformazionale del complesso molecolare debolmente legato N,N-dietilidrossilamina·acqua
   - Tesi di Laurea Magistrale
     + Synthesis, computational study and spectroscopic characterization of hydroxylamine derivatives

#### Stefano Masiero
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/stefano.masiero)
 * Tesi proposte
   - Tutte
     + <p>Chimica Organica 2 - CTF</p><p>-Sintesi di nucleosidi modificati e studio dei loro processi di autoassemblaggio</p><p>-Sintesi di materiali fotoresponsivi autoorganizzati per la conversione di energia luminosa in energia meccanica</p>
 * Tesi assegnate
   - Tesi di Laurea Magistrale a ciclo unico
     + idrogel da ibridi guanosina-amminoacido
     + Ricerca di nuovi polimeri fotoresponsivi
 ...
 * Tesi assegnate
   ...
   - Tesi di Laurea Magistrale
     + Application and evaluation of univariate and multivariate methods for hyperspectral data processing
     + Cinnabar darkening in Pompeian frescos:Identification of the environmental agents involved and first tests for the pigment protection
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Exploring the conformational space of the 2-deoxyribose···water complex: quantum mechanical calculations and rotational spectroscopy.
     + Spettroscopia rotazionale di molecole di interesse astrochimico contenenti elementi del terzo periodo: 1-propantiolo
   - Tesi di Laurea Magistrale
     + Spettro rotazionale del dimetilsilano e dei suoi isotopologhi nella regione delle onde millimetriche
   - Tesi di Dottorato
     + Non-covalent interactions in weakly bound molecular complexes: a high-resolution rotational spectroscopy study

#### Dora Melucci
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/dora.melucci)
 * Tesi proposte
   - Tutte
     + <p>TEMATICA<br>Applicazione della CHEMIOMETRIA allo sviluppo di metodologie analitiche innovative. Ricerca di metodi di analisi DIRETTI e NON ALTERATIVI</p><p>AMBITI<br>Alimentare, Ambientale, Farmaceutico, Forense</p><p>TECNICHE DI ANALISI CHIMICA UTILIZZATE<br>Cromatografia: gas-cromatografia (GC), cromatografia liquida (LC), accoppiamento con spettrometria di massa (LC-MS)<br>Voltammetria analitica<br>Spettroscopia analitica: Spettroscopia di Assorbimento Atomico (AAS), nel Vicino infrarosso (NIR), nell’infrarosso in riflettanza totale attenuata (ATR), Raman Diffrattometria di raggi X su polveri (XRPD)</p><p>COLLABORAZIONI ESTERNE<br>Dipartimento FaBiT-Unibo: Metalli tossici in piante biorisanatrici<br>Centro Ricerche Agroalimentari – Bologna: Raman di miele<br>Coop Italia – Casalecchio (BO): Flash-GC e LC-MS di alimenti<br>IMA, Ozzano Emilia (BO): Design Of Experiments (DOE) su macchine per la formulazione di farmaci</p><p>COLLABORAZIONI INTERNE<br>Prof. Laura Tositti: ATR su sedimenti ambientali<br>Prof. Lucia Maini: XRPD su forme polimorfe di farmaci</p>
 * Tesi assegnate
   - Tesi di Laurea
     + Analisi di coloranti in matrici alimentari. Confronto tra tecniche: polarografia, spettroscopia UV-VIS e IR.
     ...
     + Determinazione di metalli pesanti e della capacità antiossidante in campioni di suolo
     + Determinazione di metalli pesanti e della fase organica in terreni urbani
   - Tesi di Laurea Magistrale
     + Analisi del contenuto colloidale in AF4 e della frazione volatile in GC-IMS delle passate di pomodoro per lo sviluppo di un metodo chemiometrico-classificativo
     + Chemiometria e tecniche analitiche non distruttive per il controllo di materie plastiche da riciclo
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Microplastiche di origine tessile: emissione e distribuzione in ambiente
     + Valutazione dell'effetto inibitorio dei NaDES sull'enzima ureasi
   - Tesi di Laurea Magistrale
 ...
 * Tesi assegnate
   - Tesi di Laurea Magistrale
     ...
     + Development and evaluation of new cleaning systems for the removal of varnishes and coatings from artworks

#### Serena Silvi
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/serena.silvi)
 * Tesi proposte
   - Tutte
     + <ul>    <li>Macchine e motori molecolari artificiali</li>    <li>Sistemi supramolecolari in soluzione e in liposomi</li>    <li>Composti fotocromici </li>    <li>Nanomateriali fotoattivi</li></ul>
 * Tesi assegnate
   - Tesi di Laurea
     + Azobenzene nelle macchine molecolari
     + Photochemical characterization of Donor-Acceptor Stenhouse Adducts (DASA) in solution and within liposomal membranes
   - Tesi di Laurea Magistrale
     + Pseudorotaxanes based on luminescent calix[6]arene as prototypes of molecular machines

#### Francesca Soavi
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/francesca.soavi)
 * Tesi proposte
   - Tutte
     + <p>• Metal-Air Batteries:</p><p>-Lithium- and Aluminum-Air batteries</p>• Flow Batteries<p>- Novel chemistries and semisolid components</p><p>• Supercapacitors -miniaturization and Integration in energy harvesters (microbial fuel cells, solar cells) and autonomous devices (wearable, remote sensors, bio-medical systems)</p><p>•Bio-inspired materials and systems for energetics</p>
 * Tesi assegnate
   - Tesi di Laurea
     + Batterie redox a flusso al vanadio con elettrodi semi-solidi
     + Upscaling of supercapacitive bio-char production
   - Tesi di Laurea Magistrale
     + Studio di liquidi ionici per batterie al litio metallico
     + Towards green lithium air battery cells: a preliminary study on the use of  water-processable polymers
     + Water processing polimers for high voltages cathodes in next generations lithiun batteries
   - Tesi di Dottorato
 ...
 * Tesi assegnate
   ...
   - Tesi di Laurea Magistrale a ciclo unico
     + Fotosensibilizzatori per terapia fotodinamica approvati clinicamente
