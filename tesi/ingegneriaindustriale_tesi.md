...
[Sito Web](https://www.unibo.it/sitoweb/michele.celli3)
 - Tesi di Laurea
   ...
   + Analisi termofluidodinamica di un fluido che satura un 
mezzo poroso e applicazione dei mezzi porosi ai filtri anti
particolato
...
[Sito Web](https://www.unibo.it/sitoweb/enrico.corti2)
 - Tesi di Laurea
   ...
   + simulazione dell'impianto di 
raffreddamento acqua e olio per motori a combustione interna ed elettrici
...
[Sito Web](https://www.unibo.it/sitoweb/andrea.depascale)
 - Tesi di Laurea Magistrale
   ...
   + Development and testing of Model Predictive Controllers for an automotive organic Rankine cycle
unit
 ...
 - Tesi di Dottorato
   + Modelling of ORC components and systems for low-medium
temperature heat recovery applications with reduced
...
[Sito Web](https://www.unibo.it/sitoweb/mauro.gamberi)
 ...
 - Tesi di Laurea Magistrale
   ...
   + Installation of a real time indoor tracking system and data analysis for line-feeding monitoring at the service of the Urus Line
...
[Sito Web](https://www.unibo.it/sitoweb/matteo.gherardi4)
 ...
 - Tesi di Laurea Magistrale
   + Progettazione, sviluppo, realizzazione e caratterizzazione funzionale di sorgenti plasma freddo 
di non equilibrio a pressione atmosferica per la deposizione di film sottili
...
[Sito Web](https://www.unibo.it/sitoweb/riccardo.manzini)
 ...
 - Tesi di Laurea Magistrale
   ...
   + Soluzioni per la Digital Transformation e la Forecast Accuracy 
nel processo di pianificazione dei materiali lungo la Supply Chain. 
Il Caso G.D S.p.A.
...
[Sito Web](https://www.unibo.it/sitoweb/giangiacomo.minak)
 ...
 - Tesi di Laurea Magistrale
   ...
   + Macchina rettificatrice verticale MAS: 
analisi FEM della struttura
...
[Sito Web](https://www.unibo.it/sitoweb/cristina.mora)
 ...
 - Tesi di Laurea Magistrale
   ...
   + ANALISI E OTTIMIZZAZIONE DELLA GESTIONE DI UN MAGAZZINO RICAMBI IN OTTICA DEL 
SUO TRASFERIMENTO: IL CASO DI ACEGASAPSAMGA S.p.A.
   ...
   + applicazione dei principi di lean production e industria 4.0
in una linea di montaggio a takt time: il caso robopac smart factory
   + Applicazione dei principi di Lean Production in una linea di assemblaggio di una nuova gamma di prodotto 
Il caso Manitou Italia
   ...
   + Il budget del personale nella gestione
strategica delle risorse umane. Il caso “Marchesini Group SPA”
...
[Sito Web](https://www.unibo.it/sitoweb/piero.morelli)
 - Tesi di Laurea
   ...
   + ottimizzazione strutturale della carpenteria
di supporto per celle di carico di un banco di
prova per piedi di appoggio
...
[Sito Web](https://www.unibo.it/sitoweb/domiziano.mostacci)
 ...
 - Tesi di Laurea Magistrale
   + Gyrokinetic modelling of plasma transport
and investigation on test particle dynamics
...
[Sito Web](https://www.unibo.it/sitoweb/giovanni.naldi)
 ...
 - Tesi di Laurea Magistrale
   + Impianto didattico Mini-Hydro
Sviluppo di un sistema per l'acquisizione e l'analisi dei dati
...
[Sito Web](https://www.unibo.it/sitoweb/luca.piancastelli)
 - Tesi di Laurea
   ...
   + studio e ottimizzazione di un’elica veloce 
per ultraleggeri
   ...
   + Studio ed ottimizzazione aerodinamica
di un veicolo elettrico biposto
...
[Sito Web](https://www.unibo.it/sitoweb/alberto.regattieri)
 ...
 - Tesi di Laurea Magistrale
   ...
   + Analisi degli asservimenti logistici della nuova linea "Mixer"
Il caso Marini S.p.a.
   ...
   + analisi e ottimizzazione del material feeding tra il
magazzino componenti e un reparto assemblaggio
   ...
   + analisi ed ottimizzazione del processo di finizione di
prodotti finiti nel settore automotive. il caso magni
s.r.l.
   ...
   + applicazione dei principi lean per la
razionalizzazione dei processi manutentivi in
un’azienda manifatturiera:
il caso segafredo zanetti s.p.a.
   ...
   + cost deployment e opportunita’ all’interno delle operations di un sistema di produzione: 
il caso kverneland group
   ...
   + IL PROCESSO DI DIGITALIZZAZIONE DELLA DOCUMENTAZIONE TECNICA IN OTTICA INDUSTRIA 4.0. 
PROGETTO "PAPERLESS"
IL CASO MARCHESINI GROUP S.p.A.
   ...
   + La gestione della manutenzione all’interno di un parco divertimenti
Il caso Mirabilandia
   ...
   + Manutenzione su condizione e analisi dei ricambi per macchine automatiche nell’ottica industria 4.0. 
Il caso SACMI S.C.
   + Metodi e modelli per l’analisi della domanda di un prodotto industriale
   + metodi e modelli per la cost breakdown analysis di
prodotti inbound al sistema di produzione
il caso magni telescopic handlers
   ...
   + Ottimizzazione dei parametri di gestione della logistica inbound di un sistema di produzione 
il caso Magni Telescopic Handlers
   + Ottimizzazione dei processi produttivi in ottica Lean: il caso di Grafos Steel
   + Ottimizzazione del processo di configurazione di un bene strumentale.
Un caso nelle macchine automatiche del settore cosmetico.
   ...
   + ottimizzazione della logistica inbound dei materiali
il caso magni telescopic handlers
   ...
   + ottimizzazione della supply chain inbound di un sistema di produzione in condizioni di deficit dell’offerta
il caso magni telescopic handlers
   ...
   + ottimizzazione politiche manutentive di un bene strumentale: 
il caso sacmi s.c.
   ...
   + razionalizzazione del sistema manutentivo attraverso
l’introduzione di un cmms e dell’ “autonomous
maintenance”
...
[Sito Web](https://www.unibo.it/sitoweb/eugenia.rossidischio)
 - Tesi di Laurea
   ...
   + Applicazioni dell'energia solare fotovoltaica nel continente Africano.
   + Biomassa e sistema agro-energetico
analisi del potenziale delle aree rurali per la produzione di energia rinnovabile
...
Casi studio di ristrutturazione di edifici ad uso residenziale o commerciale
...
[Sito Web](https://www.unibo.it/sitoweb/luca.tomesani)
 - Tesi di Laurea
   ...
   + Design and optimization of a new composite ESR
prosthetic feet using FEA
...
[Sito Web](https://www.unibo.it/sitoweb/m.zannoni)
 - Tesi di Laurea Magistrale
   ...
   + Study of the rotational state of Titan using radio tracking
data of the Dragonfly mission
