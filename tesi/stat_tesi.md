 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Le preferenze dei consumatori nell’utilizzo di applicazioni di Food Delivery: un’indagine statistica
 ...
 * Tesi assegnate
   - Tesi di Laurea Magistrale
     ...
     + Inferenza sui campioni non probabilistici
 ...
 * Tesi assegnate
   ...
   - Tesi di Laurea Magistrale
     ...
     + Weather derivatives: i derivati sulla temperatura
...
#### Simone Giannerini
###### Professore associato
[Sito Web](https://www.unibo.it/sitoweb/simone.giannerini)
 * Tesi proposte
   - Tutte
     + <p><strong>&nbsp;</strong></p><p><strong>Metodi statistici per i mercati finanziari</strong><br></p><p>-utilizzo dei modelli Threshold ARMA in finanza</p><p><strong>&nbsp;</strong></p><p><strong>Processi Stocastici</strong></p><p>- Catene di Markov e sistemi bonus/malus<br></p><p>&nbsp;</p>
 * Tesi assegnate
   - Tesi di Laurea
     + Analisi del processo di sincronizzazione del frame nella sintesi delle proteine: un approccio basato sulle reti neurali.
     + SARS-CoV-2 and circular codes
   - Tesi di Laurea Magistrale
     + Catene di Markov e sistemi Bonus-Malus
     + Circular codes, reading frames and error correction in translation

#### Fedele Pasquale Greco
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/fedele.greco)
 * Tesi proposte
   - Tutte
     + <p>- Teoria dei valori estremi applicata al rischio catastrofale in ambito assicurativo</p><p>-&nbsp;Stima Bayesiana e frequentista a confronto su modelli per la volatilità stocastica</p><p>-&nbsp;Modelli Garch-Midas per la stima della volatilità</p><p>-&nbsp;La valutazione di rischio da cambiamenti climatici nella stima del rischio di default aziendale</p><p>- Approccio Bayesiano all'Asset Pricing</p><p>-&nbsp;Stima dei sinistri IBNR secondo la teoria della credibilità</p><p>-&nbsp;Analisi Bayesiana dei modelli per le assicurazioni sanitarie</p><p>&nbsp;</p><p>&nbsp;</p>
 * Tesi assegnate
   - Tesi di Laurea
     + A spatial analysis of the access to water and sanitation of Moldova from 2010 to 2020
     + An Exploratory Analysis on Gender Disparity
     + Campionamento a due stadi
     + Data Visualization and Analysis of Commodity Flow Survey with R
     + Gli effetti del COVID-19 sulla mortalità italiana
     + Metodo Montecarlo per prezzare le Opzioni
     + the effect of lockdown on air pollution in the emilia romagna region: an explorative analysis
     + The performances of the Statistical Sciences studentsSome descriptive analysis
   - Tesi di Laurea Magistrale
     + Time series clustering to enhance daily forecasting

#### Paolo Guasoni
###### Professore ordinario
[Sito Web](https://www.unibo.it/sitoweb/paolo.guasoni)
 * Tesi proposte
 * Tesi assegnate

#### Maria Letizia Guerra
###### Professoressa associata confermata
[Sito Web](https://www.unibo.it/sitoweb/mletizia.guerra)
 * Tesi proposte
   - Tutte
     + <p>-Mathematical models for Economics</p><p>- Uncertainty through fuzzy numbers</p><p>- Derivatives in the Tourism sector</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
 * Tesi assegnate
   - Tesi di Laurea
     + How finance and geopolitics shaped the world. A 1945-2018 comprehensive analysis
     + Overtourism: il caso di Venezia
   - Tesi di Laurea Magistrale
     + A sentiment analysis application in the hospitality industry: a survey on customers’ satisfaction about green practices in the italian context
     + Determinants of Tourism-Related Stocks in the Philippine Market
     + Effects of sustainable policies on luxury hotels: evidence from case studies;Sweden and Australia
...
#### Silvia Pacei
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/silvia.pacei)
 * Tesi proposte
   - Tutte
     + <p>INSEGNAMENTO: PROGETTAZIONE E REALIZZAZIONE DI INDAGINI ECONOMICHE</p><p>TEMI:</p><p>Stima per piccole aree di indicatori di povertà/disuguaglianza.</p><p>Effetti delle politiche sulla povertà/disuguaglianza delle famiglie.</p><p>Determinanti dell'innovazione&nbsp;nelle imprese.</p><p>Effetti dell'innovazione sulle performance delle imprese.</p><p>Determinanti dei comportamenti green delle famiglie.</p><p>&nbsp;</p>
 * Tesi assegnate
   - Tesi di Laurea Magistrale
     + Il Comportamento dei Giovani durante il Lockdown: il caso degli Studenti Clamsei
     + La previsione delle vendite aziendali con e senza promozione mediante modelli SARIMA
     + La situazione economica delle famiglie: un'analisi a livello nazionale e un confronto con i Paesi europei
     + L'imputazione di dati mancanti: applicazione dei modelli all’indagine sui bilanci delle famiglie italiane
     + L'innovazione tecnologica come motore dello sviluppo delle aziende. Il caso Safilo.
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Analisi delle compagnie aeree quotate in borsa: evoluzione e impatto del covid
     + Analisi tecnica e fondamentale nel trading online
     + Bolla nel settore tecnologico? Un’analisi empirica del settore automotive
     + Club sportivi: la reazione di mercato ai risultati delle competizioni
     + Covid-19 e IPO: due casi a confronto
     + Dalla crisi sanitaria alla crisi economica: gli effetti della pandemia sui mercati finanziari
     + Determinanti della profittabilità: il caso delle Imprese di assicurazione
     + Educazione finanziaria e teoria del portafoglio
     + Effetti della pandemia sui modelli di business bancari: il caso Mediolanum
     + Finanza comportamentale: approcci ed applicazioni alle teorie di struttura del capitale
     + Finanza comportamentale: come la psicologia influenza le politiche di struttura del capitale in azienda.
     + Finanza e calcio, due mondi paralleli
     + Finanza etica: origini, strumenti e performance
     + il calcio al tempo del covid: analisi del settore e reazione alla pandemia. caso aziendale: aumento di capitale juventus f.c
     + Il fenomeno del market abuse: il ruolo dell’informazione nel mercato e la regolamentazione delle condotte illecite
     + il private equity a sostegno dell’economia reale: il caso moncler s.p.a.
     + Il processo di prima quotazione: l'IPO di Airbnb
     + Il ruolo della finanza aziendale comportamentale nelle politiche di struttura del capitale
     + Impatto del risultato agonistico sul rendimento azionario delle squadre di calcio quotate in Borsa
     + Imprese quotate in Area Euro: analisi della redditività
     + Incertezza e responsabilità: da Fischer Black al caso Metallgesellschaft
 ...
 * Tesi assegnate
   ...
   - Tesi di Laurea Magistrale
     ...
     + Carte di Controllo Geometriche: teoria e aspetti pratici
 ...
 * Tesi assegnate
   ...
   - Tesi di Laurea Magistrale
     ...
     + Pianificazione di MarketingAnalisi statistica a supporto dell’ingresso nel mercato del servizio alla ristorazione.
