...
[Sito Web](https://www.unibo.it/sitoweb/alberto.arcioni)
 * Tesi proposte
 * Tesi assegnate

#### Barbara Ballarin
###### Professoressa associata confermata
[Sito Web](https://www.unibo.it/sitoweb/barbara.ballarin)
 * Tesi proposte
   - Tutte
     + <p><strong>Laurea magistrale</strong></p><p>&nbsp;</p><p>-Sviluppo di sensori PANI/Cellulosa per applicazioni nel settore alimentare</p><p>-Sviluppo di sensori MOF per applicazioni nel settore ambientale</p>
 * Tesi assegnate
...
#### Giorgio Bencivenni
###### Professore associato
[Sito Web](https://www.unibo.it/sitoweb/giorgio.bencivenni2)
 * Tesi proposte
   - Tutte
     + <p>1) Asymmetric Crotylation and allylation reaction </p><p>2) Asymmetric synthesis of novel N-N atropisomers</p><p>3) Atroposelective Pd catalyzed reactions</p><p>4) Computational studies of reaction mechanisms</p>Seguimi su:&nbsp;<a href="https://site.unibo.it/organic-catalysis-structural-analysis/en/laboratori/asymmetric-synthesis-lab">Asymmetric Synthesis Lab</a>
 * Tesi assegnate
   - Tesi di Laurea Magistrale
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Studio della pirolisi di miscele di plastiche
   - Tesi di Laurea Magistrale
     + Ricerca dei fattori determinanti nel miglioramento della forma fisica di estrusi di elastomeri termoplastici SEBS
     + Sintesi di polialchilmetacrilati ad alto peso molecolare
     + Studio di nanocompositi di TPU/grafene per additive manufacturing

#### Patricia Benito Martin
###### Foto  non disponibile
...
[Sito Web](https://www.unibo.it/sitoweb/daniele.nanni)
 * Tesi proposte
   - Tutte
     + Possibili Tesi di Laurea<ul>    <li>Studio di nuovi sistemi nanostrutturati per possibili applicazioni in catalisi eterogenea</li></ul>
 * Tesi assegnate
   - Tesi di Laurea
     + Determinazione della quantità di idrocarburi policiclici aromatici (IPA) adsorbiti sul nero di carbonio.
     + Prodotti pigmentati a base acquosa.

#### Artur Nenov
###### Ricercatore a tempo determinato tipo b) (senior)
[Sito Web](https://www.unibo.it/sitoweb/artur.nenov)
 * Tesi proposte
 * Tesi assegnate

#### Silvia Orlandi
###### Ricercatrice confermata
[Sito Web](https://www.unibo.it/sitoweb/s.orlandi)
 * Tesi proposte
 * Tesi assegnate

#### Alessandro Paglianti
###### Professore ordinario
[Sito Web](https://www.unibo.it/sitoweb/alessandro.paglianti)
 * Tesi proposte
   - Tutte
     + <p>1) Ottimizzazione del funzionamento di un digestore anaerobico per la produzione di biogas da biomasse di scarto</p><p><br>2) Ottimizzazione in un fermentatore aerobico modello: effetto delle caratteristiche geometriche sulla fluidodinamica gas-liquido </p><p><br>3) Distribuzione dimensionale di bolle in reattori agitati per applicazioni farmaceutiche</p><p><br>4) Dispersione di liquidi immiscibili per applicazioni nelle formulazioni industriali</p><p><br>5) Distribuzione dimensionale di gocce in reattori liquido-liquido agitati meccanicamente</p><p><br>6) Caratterizzazione sperimentale di giranti per la miscelazione di fluidi complessi e miscele solido-liquido</p><p><br>7) Simulazione CFD del funzionamento di un separatore gas-liquido </p><p><br>8) Scale-up di reattori multifase tramite metodi computazionali</p><br>
 * Tesi assegnate
   - Tesi di Laurea
     + La gestione del rifiuto chimico e l'End of Waste
   - Tesi di Laurea Magistrale
     ...
     + Analisi sperimentale delle prestazioni di filtri-essiccatori per applicazioni in ambito farmaceutico
     + Analisi sperimentale di un processo di formulazione per la detergenza e la cura della persona
     ...
     + Comparison of flow within an artery in vitro using Newtonian and non-Newtonian blood mimicking fluids
     + Criteri di scale-down e analisi sperimentale di reattori industriali per la miscelazione di polveri e fluidi viscosi
     ...
     + Ottimizzazione Analisi RAM e descrizione del processo di distillazione di un impianto Oil&Gas
...
#### Ivano Vassura
###### Professore associato
[Sito Web](https://www.unibo.it/sitoweb/ivano.vassura)
 * Tesi proposte
   - Tutte
     + <p>Attualmente i temi di possibili tesi/elaborati finali, presso i laboratori del Tecnopolo di Rimini, riguardano:</p><p>1) Leaching test per lo studio del rilascio di Fosfati da materiali di recupero per l'agricoltura.<br></p><p>2) Studio tramite tecniche in pirolisi analitica &nbsp;di micoplastiche in matrici ambientali.</p><p>3) studio di contaminanti emergenti emessi da impianti di depurazione acque.</p><p>4) caratterizzazione di contaminanti in processi industriali di riutilizzo e trattamento termico di fanghi organici.<br></p>
 * Tesi assegnate
   - Tesi di Laurea
     + Analisi acque sotterranee
     + Analisi e campionamento di terre e rocce da scavo tramite GC-FID per determinare la qualifica come sottoprodotto o rifiuto
     + Analisi metodiche per la ricerca di metalli in terreni per bonifica
     + Analytical method for characterizing pyrolysis products of PEI
     + Bonifica ed elaborazione dei dati sulle macerie del terremoto del Centro Italia nell'anno 2016
     + Tecniche di fingerprinting per la caratterizzazione chimica di sversamenti idrocarburici
   - Tesi di Laurea Magistrale
     + Pre-treatment of sewage sludge with Fenton’speroxidation for the analysis of microplastics byanalytical pyrolysis
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Studio spettroscopico della reazione di dimerizzazione in stato solido della vitamina K3

#### Stefano Zacchini
###### Professore ordinario
[Sito Web](https://www.unibo.it/sitoweb/stefano.zacchini)
 * Tesi proposte
   - Tutte
     + <p>Sintesi e caratterizzazione di nanocluster molecolari dei metalli di transizione.&nbsp;</p><p>Applicazione di cluster carbonilici in catalisi omogenea.</p><p>Nanocluster molecolari contenenti elementi del blocco p.&nbsp;</p><p>Cluster carburo carbonilici di ferro come modelli di sistemi biologici.</p><p>Cluster metallo-idrurici</p>
 * Tesi assegnate
   - Tesi di Laurea
     + Sintesi di cluster carbonilici di Ru contenenti metalli da conio
