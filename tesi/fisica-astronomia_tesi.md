...
[Sito Web](https://www.unibo.it/sitoweb/carlo.battilana2)
 * Tesi proposte
 * Tesi assegnate
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Analisi della dinamica su network
     + Effetti di congestione per modelli di traffico su rete stradale: uno studio su Bologna
   ...
   - Tesi di Laurea Magistrale
     ...
     + Linear response and stability for Lotka-Volterra and SIR models
     + Optimisation of LHC Integrated Luminosity
     + Synchronisation Phenomena in Complex Neuronal Networks

#### Maria Elina Belardinelli
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/mariaelina.belardinelli)
 * Tesi proposte
 * Tesi assegnate

#### Sirio Belli
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/sirio.belli)
 * Tesi proposte
 * Tesi assegnate

#### Francesca Bellini
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/f.bellini)
 * Tesi proposte
   - Tutte
     + <p><strong>Fisica - Fisica Nucleare e subnucleare.</strong> <br><br>La docente propone attualmente argomenti di tesi di Laurea Triennale e/o Magistrale nell'ambito della fisica nucleare e subnucleare, in particolare legati al progetto di ricerca CosmicAntiNuclei e all'esperimento ALICE ad LHC. L'elenco di argomenti proposto di seguito è indicativo degli interessi del gruppo di ricerca e si invita caldamente a contattare la docente per ulteriori dettagli o per aggiornamenti.&nbsp;</p><ul>    <li>Meccanismi di formazione di adroni e nuclei leggeri</li>    <li>Studio del meccanismo di coalescenza per la produzione di nuclei di antimateria in interazioni adroniche di alta energia</li>    <li>Caratterizzazione della sorgente di protoni e antiprotoni in collisioni protone-protone a LHC</li>    <li>Formazione e propagazione di antinuclei leggeri da interazione di raggi cosmici primari nella Galassia</li>    <li>Identificazione di nuclei leggeri con il rivelatore TOF di ALICE</li>    <li>Misura della produzione di antinuclei leggeri in collisioni di alta energia con ALICE</li>    <li>Produzione di risonanze adroniche e stati "esotici" in collisioni di alta energia </li>    <li><span style="font-size: 12.8px;">Studio di performance di rivelatori per l'identificazione di particelle per esperimenti di fisica nucleare delle alte energie</span><br>    </li></ul>
 * Tesi assegnate
...
#### Sylvie Braibant
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/sylvie.braibant)
 * Tesi proposte
 * Tesi assegnate

#### Erika Brattich
###### Ricercatrice a tempo determinato tipo a) (junior)
[Sito Web](https://www.unibo.it/sitoweb/erika.brattich)
 * Tesi proposte
 * Tesi assegnate
...
#### Leonardo Brizi
###### Ricercatore a tempo determinato tipo a) (junior)
[Sito Web](https://www.unibo.it/sitoweb/leonardo.brizi2)
 * Tesi proposte
 * Tesi assegnate

#### Marcella Brusa
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/marcella.brusa3)
 * Tesi proposte
   - Tutte
     + <p>Elenco e descrizione delle tesi disponibili nell'ambito del tema di ricerca della co-evoluzione galassie e AGN.</p><p><strong>1) Feedback effects in an obscured QSO at z~1.5</strong><br>goal: study of the spatial distribution of ionised gas in comparison to that of star formation in search for feedback effects<br>collaborator: G. Cresci (INAF-OAArcetri) </p><p><strong>2) The environment of an obscured, outflowing QSO at z~1.5</strong><br>goal: characterise the dust and SF properties of a bright submm source, its gas content, and assess the physical relation with a bright obscured QSO at ~170 projected kpc<br>collaborators: R. Paladino (INAF-IRA) E. Daddi (CEA) </p><p><br><strong>3) The radio emission in a X-ray luminous CSS with strong ionised wind at z~1.5</strong><br>goal: assess the role of jets and sub-kpc radio emission in driving outflows <br>collaborator: I. Delvecchio (Zagreb University) </p><p><strong>4) A four-dimensional study (Muse 3D+ HST-ACS) of an obscured AGN in the J1030 field</strong><br>goal: study the velocity field of low- and high-ionisation gas, and investigate for the presence of kpc-scale outflows<br>collaborator: M. Mignoli + J1030 team</p><p><br><strong>5) Unveiling AGN excitation in 5 X-ray Bright Optically Normal Galaxies (XBONGs) </strong><br>goal: disentangle host galaxies and AGN light in these peculiar systems, and map the stellar and extended narrow line region kinematics <br>collaborator: M. Mignoli + A. Comastri (INAF-OABo)<br><br><strong>6) X-ray properties of galaxies with HI outflows</strong><br>goal: assess X-ray properties and/or other phases outflows incidence in radio selected galaxies with HI outflows<br>collaborator: G. Lanzuisi (DIFA) </p><p><strong>7) Mass without radiation: Heavily obscured AGNs, the X-ray background, and the black hole mass density </strong><br>goal: derive observational constraints to be used to search for the most obscured AGN responsible for the XRB <br>collaborator: A. Comastri (INAF-OABo) </p><p><strong>8) The cold side of AGN: dust, gas, and star formation in high-z AGN from Herschel and ALMA </strong><br>goal: construct average SED of AGN in luminosity classes, investigate their dust and gas content and compare them to “normal” galaxies <br>collaborator: R. Decarli (INAF-OABo)<br><br><br></p>
 * Tesi assegnate
   - Tesi di Laurea
     + Caratteristiche principali dell'emissione di galassie a spirale
     + Emissione di Bremsstrahlung e applicazioni astrofisiche
     + La metrica dei buchi neri: applicazioni astrofisiche
     + Misurare la massa in Buchi neri: il caso di Sagittarius A*
 ...
 * Tesi assegnate
   ...
   - Tesi di Laurea Magistrale
     ...
     + Defects analysis on multicrystalline silicon for solar cells applications
...
#### Nicoletta Mauri
###### Ricercatrice a tempo determinato tipo b) (senior)
[Sito Web](https://www.unibo.it/sitoweb/nicoletta.mauri2)
 * Tesi proposte
 * Tesi assegnate

#### Raffaello Mazzaro
###### Ricercatore a tempo determinato tipo a) (junior)
[Sito Web](https://www.unibo.it/sitoweb/raffaello.mazzaro)
 * Tesi proposte
 * Tesi assegnate

#### Lorenzo Mentaschi
###### Ricercatore a tempo determinato tipo a) (junior)
[Sito Web](https://www.unibo.it/sitoweb/lorenzo.mentaschi)
 * Tesi proposte
 * Tesi assegnate

#### Robert Benton Metcalf
###### Professore associato
[Sito Web](https://www.unibo.it/sitoweb/robertbenton.metcalf)
 * Tesi proposte
 * Tesi assegnate

#### Andrea Miglio
###### Professore ordinario
[Sito Web](https://www.unibo.it/sitoweb/andrea.miglio)
 * Tesi proposte
 * Tesi assegnate

#### Francesco Minardi
###### Professore associato
[Sito Web](https://www.unibo.it/sitoweb/francesco.minardi)
 * Tesi proposte
 * Tesi assegnate
...
#### Emanuele Paci
###### Professore associato
[Sito Web](https://www.unibo.it/sitoweb/e.paci)
 * Tesi proposte
 * Tesi assegnate

#### Cristina Pallanca
###### Ricercatrice a tempo determinato tipo a) (junior)
[Sito Web](https://www.unibo.it/sitoweb/cristina.pallanca3)
 * Tesi proposte
 * Tesi assegnate

#### Salvatore Pascale
###### Ricercatore a tempo determinato tipo a) (junior)
[Sito Web](https://www.unibo.it/sitoweb/salvatore.pascale)
 * Tesi proposte
 * Tesi assegnate

#### Silvia Pascoli
###### Professoressa ordinaria
[Sito Web](https://www.unibo.it/sitoweb/silvia.pascoli)
 * Tesi proposte
 * Tesi assegnate

#### Luca Pasquini
###### Professore associato
[Sito Web](https://www.unibo.it/sitoweb/luca.pasquini)
 * Tesi proposte
   - Tutte
     + <p><strong>MASTER DEGREE in PHYSICS</strong></p><p>1) Metal oxide nanostructures as photoanodes for energy conversion </p><p>2) Nanoalloys of transition metals as electrocatalysts for energy conversion</p><p>3) Semiconductor photoanodes fabricated by magnetron sputtering</p><p>4) Hydrogen storage properties of magnesium-based nanostructures</p><p><strong>LAUREA IN FISICA</strong></p><p>1) Analisi sperimentale di struttura e proprietà di materiali per lo stoccaggio di idrogeno allo stato solido&nbsp;</p><p>2) Fabbricazione di fotoelettrodi per la conversione dell'energia solare e loro caratterizzazione foto-elettronica</p><p>3) Simulazione numerica di trasformazioni nei solidi con il metodo phase-field modeling; esempi includono decomposizione spinodale, transizioni ordine-disordine, coarsening, etc.</p><p>&nbsp;</p>
 * Tesi assegnate
   - Tesi di Laurea
     + Caratterizzazione di fotoanodi di WO_3 mediante spettroscopia di impedenza elettrochimica e transienti di fotocorrente
     + Studio di fotoanodi di ematite mediante transienti di fotocorrente e spettroscopia di impedenza elettrochimica
   - Tesi di Laurea Magistrale
     + Growth and characterization of a $ CuIn_{0.7}Ga_{0.3}Se_2/CdS£  photocathode
     + Nucleation and growth of iron nanoparticles by gas phase condensation
     + Thickness effects on electrochemical and gas-phase Hydrogen loading in Magnesium thin films

#### Silvia Pellegrini
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/silvia.pellegrini)
 * Tesi proposte
 * Tesi assegnate
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Software basati su algoritmi di Intelligenza Artificiale in neuroradiologia e radiologia: criteri di validazione e utilizzo
...
#### Giordano Teza
###### Ricercatore a tempo determinato tipo a) (junior)
[Sito Web](https://www.unibo.it/sitoweb/giordano.teza)
 * Tesi proposte
 * Tesi assegnate

#### Francesco Trotta
###### Ricercatore a tempo determinato tipo a) (junior)
[Sito Web](https://www.unibo.it/sitoweb/francesco.trotta4)
 * Tesi proposte
 * Tesi assegnate
...
#### Franco Vazza
###### Professore associato
[Sito Web](https://www.unibo.it/sitoweb/franco.vazza2)
 * Tesi proposte
   - Tutte
     + <p>Una lista aggiornata di possibili tesi di Laurea Magistrale include:</p><p>&nbsp;</p><p><strong>1. </strong><strong>The history of shocked baryons in the intracluster medium. </strong></p><ul>    <li><em>&nbsp;</em>non sappiamo quanto spesso nel passato le particelle del mezzo intra-cluster siano state attraversate da onde di shock, e questa frequenza di shock influenza lo spettro osservabile delle particelle relativistiche (elettroni e protoni) negli ammassi di galassie. &nbsp;</li></ul><ul>    <li><em>Il progetto: </em> studiare &nbsp;per la prima volta quanto spesso le particelle del mezzo intracluster sono state shocckate, e da quali shock (merger o accretion shocks?). </li></ul><ul>    <li><em>Metodo: </em> analisi della propagazione delle particelle di gas in simulazioni molto risolte di ammassi di galassie, ottenute col codice a griglia Enzo ed usando particelle "passive" iniettate nella simulazione, per registrare la sequenza degli eventi più energetici nel corso della vita degli ammassi.&nbsp;</li>    <li>&nbsp;Alcune referenze utili: <a href="https://arxiv.org/abs/1610.05305">Wittor et al. 2017</a> &nbsp;; <a href="http://adsabs.harvard.edu/abs/2010A%26A...513A..32V">Vazza et al. 2011</a>&nbsp;; <a href="https://arxiv.org/abs/1706.02315">Wittor et al. 2018</a>&nbsp;</li></ul><p><strong>&nbsp;</strong></p><p><strong>2. The maximal non-thermal emission from the cosmic web&nbsp;</strong></p><ul>    <li><em>Caso scientifico</em><em>: </em>la formazione delle strutture cosmiche procede tramite la dissipazione dell'energia cinetica di infall del gas e della materia oscura, per mezzo di shock ed altri processi dissipativi. L'emissione non termica (in banda radio) può al massimo usare una frazione di questa energia: quant'è il massimo possibile, in funzione della scala spaziale, dell'ambiente e dell'epoca cosmica?</li></ul><ul>    <li><em>Il progetto</em>: derivare il collegamento &nbsp;fisico tra energia cinetica libera in funzione dell'ambiente cosmico ed emissione radio in funzione della frequenza, con attenta valutazione delle assunzioni cruciali.&nbsp;</li></ul><ul>    <li><em>Metodi</em>: analisi numerica di simulazioni cosmologiche con il codice a griglia ENZO e calcoli analitici.</li></ul><ul>    <li><strong>Tesi in collaborazione con G. Brunetti (IRA).</strong></li></ul><ul>    <li><em>Alcune pubblicazioni di riferimento: <a href="https://ui.adsabs.harvard.edu/abs/2020PhRvL.124e1101B/abstract">Brunetti &amp; Vazza 2020</a></em></li></ul><p><strong><br></strong></p><p>E' tuttavia sempre possibile per gli studenti, se hanno delle idee sufficientemente chiare sulla materia, di proporre tesi particolari sulle tematiche di competenza del docente.&nbsp;</p><p>Tutte le tesi proposte sono fortemente incentrate sull'utilizzo di simulazioni numeriche (con livelli di difficoltà concordabili di volta in volta in base alle capacità ed interesse degli studenti) come strumento per meglio conoscere la fisica del gas e del campo magnetico nelle strutture più grandi del Cosmo. E' necessario un livello minimo di conoscenza ed interesse per il calcolo numerico, ma non necessariamente di un linguaggio di programmazione in particolare; il relatore di preferenza propone lo sviluppo e/o l'utilizzo di algoritmi scritti in Julia (https://julialang.org) , probabilmente il linguaggio di programmazione più versatile e performante per lo sviluppo di nuovi codici scientifici.&nbsp;</p><p>Tutte le tesi sono pensate per arrivare a produrre, nell'arco del progetto stesso o poco dopo il medesimo, almeno una pubblicazione scientifica - così è stato per tutte le tesi magistrali da me finora proposte in Italia, o in precedenza all'Università di Amburgo:</p><p><em>Manuel O. Stubbe (2015)</em> -&gt;&nbsp;<a href="https://arxiv.org/abs/1603.02688">https://arxiv.org/abs/1603.02688</a></p><p><em>Stephan Hackstein (2016) </em>-&gt;&nbsp;<a href="https://arxiv.org/abs/1607.08872">https://arxiv.org/abs/1607.08872</a> e&nbsp;<a href="https://arxiv.org/abs/1710.01353">https://arxiv.org/abs/1710.01353</a></p><p><em>Paul M. Hinz (2017)</em> -&gt; <a href="https://arxiv.org/abs/1805.11113">https://arxiv.org/abs/1805.11113 </a>e&nbsp;<a href="https://arxiv.org/abs/1711.02669">https://arxiv.org/abs/1711.02669</a></p><p><em>Matteo Angelinelli (2018)</em>-&gt;&nbsp;<a href="https://arxiv.org/abs/1809.02690">https://ui.adsabs.harvard.edu/abs/2020MNRAS.495..864A/abstract</a></p><p><em>Marco Simonte (2020)&nbsp;</em></p><p><em>&nbsp;</em><em>&gt;&nbsp;<a href="https://ui.adsabs.harvard.edu/abs/2022A%26A...658A.149S/abstract">https://ui.adsabs.harvard.edu/abs/2022A%26A...658A.149S/abstract</a></em></p><p>&nbsp;</p>
 * Tesi assegnate
   - Tesi di Laurea Magistrale
...
#### Mauro Villa
###### Professore ordinario
[Sito Web](https://www.unibo.it/sitoweb/mauro.villa)
 * Tesi proposte
   - Tutte
     + <p><strong>Acquisizione dati per l'esperimento FOOT.</strong></p><p>Si propone di contribuire allo sviluppo del sistema di acquisizione per l'esperiemento FOOT, volto a misurare sezioni d'urto nucleari di interesse nell'ambito delle terapie oncologiche con fasci di ioni. Nello sviluppo della tesi si useranno le più recenti tecniche di C++, threading e architetture distribuite (per CdL in Fisica), VHDL e SoC (per CdL in Ing. Elettronica).</p><p>&nbsp;</p><p><strong>Ricostruzione di tracce, simulazione e analisi dati per l'esperimento FOOT.</strong></p><p>Nell'esperimento FOOT è possibile contribuire allo sviluppo della fase di analisi dei dati, partecipando alla ricostruzione delle tracce nucleari, analizzando dati di simulazione o dati presi in corrispondenza di una recente campagna di misure presso il laboratorio internazionale GSI.&nbsp; (per CdL in Fisica) </p><p>&nbsp;</p><p><strong>Studio, test e caratterizzazione di prototipi di rivelatori a pixel per l'esperimento ATLAS.</strong></p><p>Nell'ambito dell'esperimento ATLAS al CERN è in fase di avvio una campagna di misure e caratterizzazione di rivelatori di pixel per il futuro rivelatore di vertice dell'esperiemento. Si propongono tesi sperimentali e di laboratorio (anche in camera pulita) dove lo studente verrà a contatto con i rivelatori della prossima generazione di esperimenti nella fisica delle alte energie.</p><p>&nbsp;</p><p>&nbsp;</p>
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Il Simulatore di Fascio Hardware nell'Esperimento FOOT
     + Metodo per l’identificazione dei frammenti nucleari nell’esperimento FOOT
     + Ottimizzazione dei parametri di ricostruzione per l’identificazione dei neutroni con l’apparato FOOT
     + Studio di frammentazione secondaria nell'ambito del tracciamento di frammenti nucleari nell'esperimento FOOT
     + Tests di una scheda del sistema di acquisizione dell'esperimento FOOT
   - Tesi di Laurea Magistrale
...
#### Filippo Zaniboni
###### Professore associato
[Sito Web](https://www.unibo.it/sitoweb/filippo.zaniboni)
 * Tesi proposte
 * Tesi assegnate
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + La deossigenazione degli oceani nel clima che cambia
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Sistemi a due Stati
     + sistemi quantistici a due stati
     + Struttura fine dell'atomo idrogenoide
     + Teoria del funzionale di Densità
     + Teoria della diffusione con il metodo dell'espansione in onde parziali
