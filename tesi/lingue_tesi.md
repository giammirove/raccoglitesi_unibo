 ...
 * Tesi assegnate
   ...
   - Tesi di Laurea Magistrale
     ...
     + L'Europe meurt « d'une pneumonie dans les courants d'air et d’idées ». Yvan Goll et l'évolution de sa pensée sur l’Europe
 ...
 * Tesi assegnate
   ...
   - Tesi di Laurea Magistrale
     ...
     + Postcolonialism and Translation in Nigeria. A Translation Proposal of Chinua Achebe’s Chike and the River
 ...
 * Tesi proposte
   - Tutte
     + <p><strong>Ambiti</strong></p><ul>    <li>Lessico e morfologia</li>    <li>Semantica lessicale e grammaticale</li>    <li>Sintassi e discorso<br>    </li></ul><p><strong>Fenomeni</strong></p><ul>    <li>Grammatica delle costruzioni e costruzionalizzazione&nbsp;</li>    <li>Costruzioni a lista (<a href="http://www.lilec.it/list/">http://www.lilec.it/list/</a>)<br>    </li>    <li>Costruzioni emergenti (grammatica emergente dal discorso)</li>    <li>Competizione tra costruzioni nel linguaggio naturale<br>    </li>    <li>Formazione dei lessemi e <em>concept-naming</em>&nbsp;<em>strategies</em></li>    <li>Espressioni multiparola e linguaggio figurato</li>    <li>Espressione linguistica dell'approssimazione (o vaghezza intenzionale)</li></ul><p><strong>Metodologia</strong></p><p>I fenomeni sono analizzabili da diverse prospettive (intralinguistica, contrastiva, tipologica), preferibilmente con metodologia empirica e <em>corpus-based</em>.<br></p>
 * Tesi assegnate
   - Tesi di Laurea Magistrale
