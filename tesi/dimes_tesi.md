 ...
 * Tesi assegnate
   - Tesi di Laurea Magistrale a ciclo unico
     ...
     + Impatto prognostico dell'insufficienza renale nei pazienti candidati ad estrazione di dispositivo di elettrostimolazione cardiaca
...
#### Marco Garofalo
###### Ricercatore confermato
[Sito Web](https://www.unibo.it/sitoweb/marco.garofalo)
 * Tesi proposte
 * Tesi assegnate
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Ingegnerizzazione di un Herpes Simplex Virus oncolitico re-targhettato trascrizionalmente
     + La Biologia in AulaSaggio della fosfatasi alcalina del latte e isolamento dei fermenti lattici dello yogurt
     + Valutazione dell’antibiotico-resistenza di colonie di Escherichia coli isolate da urine umane

#### Catia Giovannini
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/catia.giovannini4)
 * Tesi proposte
 * Tesi assegnate

#### Maria Ida Gobbini
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/mariaida.gobbini)
 * Tesi proposte
 * Tesi assegnate
 ...
 * Tesi assegnate
   - Tesi di Laurea Magistrale a ciclo unico
     ...
     + fattori predittivi alla pet/tc con 18f-fdg e mezzo di contrasto iodato in pazienti con colangiocarcinoma intraepatico: uno studio retrospettivo
     + L'Angio-TC preoperatoria nello studio dei lembi DIEP in pazienti sottoposte a chirurgia di ricostruzione mammaria dopo mastectomia: il protocollo "Bologna".
     + Trattamento endovascolare delle malformazioni artero-venose uterine, case report e revisione della letteratura.
     + valutazione dell’efficacia dell’embolizzazione transarteriosa percutanea nel trattamento delle emorragie della parete addominale anteriore e confronto tra approccio target ed empirico
   - Tesi di Scuola di Specializzazione
 ...
 * Tesi assegnate
   ...
   - Tesi di Laurea Magistrale
     + Progettazione di banchi di prova per l'analisi dell’attività microembolica di un circuito innovativo per la circolazione extracorporea
     + Progettazione e sviluppo con tecniche di stampa 3D di un simulatore multimateriale paziente specifico per la chirurgia endoscopica dei seni paranasali.
     + Progettazione e sviluppo di un applicativo di guida intraoperatoria in realtà aumentata con visualizzazione stereoscopica per robot chirurgico Da Vinci
     + Progettazione e sviluppo di un'applicazione di realtà aumentata su HoloLens per la valutazione di pazienti affetti da alterazioni mascellari o dell'articolazione temporo-mandibolare
     ...
     + Studio di materiali per la stampa 3D di modello di rene per il training chirurgico
     + Sviluppo di un tool di caratterizzazione delle prestazioni di motori a levitazione magnetica di un dispositivo ECMO e ottimizzazione dell’algoritmo di controllo motore a velocità ridotte

#### Carlo Mariani
###### Ricercatore a tempo determinato tipo a) (junior)
[Sito Web](https://www.unibo.it/sitoweb/carlo.mariani5)
 * Tesi proposte
 * Tesi assegnate

#### Pasquale Marrazzo
###### Ricercatore a tempo determinato tipo a) (junior)
[Sito Web](https://www.unibo.it/sitoweb/pasquale.marrazzo2)
 * Tesi proposte
 * Tesi assegnate

#### Giovanni Martinelli
###### Professore associato confermato
[Sito Web](https://www.unibo.it/sitoweb/giovanni.martinelli2)
 * Tesi proposte
 * Tesi assegnate

#### Marcella Martinelli
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/marcella.martinelli)
 * Tesi proposte
 * Tesi assegnate
 ...
 * Tesi assegnate
   ...
   - Tesi di Laurea Magistrale
     + Il distress psicologico negli studenti di Infermieristica: una revisione della letteratura.
     + Interventi di self-care professionale in ambito sanitario: uno studio pilota
     + Studio pilota: indagine sul benessere degli studenti senior all'interno del progetto near peer teaching nel corso di laurea triennale in infermieristica

#### Francesco Massari
###### Ricercatore a tempo determinato tipo b) (senior)
[Sito Web](https://www.unibo.it/sitoweb/francesco.massari8)
 * Tesi proposte
 * Tesi assegnate

#### Katia Mattarozzi
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/katia.mattarozzi)
 * Tesi proposte
   - Tutte
     + <ul>    <li>Effetti della prima impressione sul comportamento e sulla presa di decisione in ambito sanitario</li>    <li>Modulazione Sociale del Dolore</li>    <li>Il ruolo del contesto psicosociale attorno al paziente e alla terapia sugli outcomes clinici</li>    <li>Effetto Nocebo da COVID-19 sui sintomi dell’influenza stagionale</li>    <li>Effetto Nocebo sugli effetti avversi comuni della vaccinazione anti-Covid-19</li>    <li>Gli effetti del COVID-19 sulle interazioni sociali</li></ul>
 * Tesi assegnate
   - Tesi di Laurea
     + LA PRIORITA’ DI SOCCORSO SUL TERRITORIO: uno studio osservazionale sull’ effetto di valenza ed arousal del contenuto della chiamata sulla decisione del call-takers 118.
     + Effetto nocebo da COVID-19 sui sintomi dell'influenza stagionale.
     + La priorità di soccorso durante la pandemia COVID-19: Effetti della prima impressione derivante dalla voce del chiamante sulle decisioni dei call-takers
     + LA PRIORITÀ DI SOCCORSO NEL PERIODO DI EMERGENZA SANITARIA COVID-19: effetti di inferenze implicite derivanti dalle caratteristiche percettive della voce del cittadino
     + Modulazione sociale del dolore: effetti della familiarità
     + Task Race Bias on Emotion Recognition

#### Michela Mazzetti
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/michela.mazzetti)
 * Tesi proposte
 * Tesi assegnate

#### Micaela Mitolo
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/micaela.mitolo)
 * Tesi proposte
 * Tesi assegnate
 ...
 * Tesi assegnate
   ...
   - Tesi di Laurea Magistrale
     + Analisi dell'RNA ribosomiale 5.8S nelle sue due isoforme short e long mediante Fragment Analysis nel carcinoma della mammella
     + Contributo della pseudouridina sintasi discherina nel carcinoma mammario: ruolo degli H / ACA box snoRNA.
     + Protoni e X-ray a confronto nella stimolazione di pathways p53-related e immunogenici in cellule A375
     + valutazione sito – specifica del profilo di pseudouridilazione dell’rna ribosomiale nel tumore della mammella
   - Tesi di Scuola di Specializzazione
     + Analisi degli studi di siero-prevalenza IgG anti-SARS-CoV-2 e del protocollo regionale per la raccolta di plasma da convalescente per la terapia della COVID-19 nella popolazione dei donatori di sangue intero ed emocomponenti dell’Area Vasta Emilia Centro: il Santo vale la candela?
 ...
 * Tesi assegnate
   ...
   - Tesi di Scuola di Specializzazione
     + Gli effetti di diversi tipi di supporto respiratorio non invasivo sullo sforzo inspiratorio in pazienti affetti da insufficienza respiratoria secondaria a polmonite SARS COV II di grado moderato severo
 ...
 * Tesi assegnate
   - Tesi di Laurea Magistrale a ciclo unico
     ...
     + Ruolo della Pronazione nei pazienti non intubati affetti da polmonite da Sars-CoV-2

#### Carmine Pizzi
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/carmine.pizzi)
 * Tesi proposte
   - Tutte
     + <p>Gli argomenti proposti per le future tesi sono i miei ambiti di ricerca:</p><p>1) Cardiopatia ischemica acuta e cronica, in particolare la fisiopatologia, la diagnostica e la terapia farmacologica</p><p>2) Masse cardiache: in particolare aspetti clinici, diagnostici e terapeutici delle masse cardiache</p><p>3) Fibrillazione atriale aspetti clinici e diagnostici. <br></p>
 * Tesi assegnate
   - Tesi di Laurea Magistrale a ciclo unico
     + Impatto prognostico dei criteri diagnostici secondo la quarta definizione universale di infarto miocardico acuto
     + Ruolo prognostico della coronarografia nell'infarto miocardico acuto

#### Venerino Poletti
###### Professore straordinario a tempo determinato art.1 co.12 l.230/2005
[Sito Web](https://www.unibo.it/sitoweb/venerino.poletti)
 * Tesi proposte
 * Tesi assegnate

#### Letizia Polito
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/letizia.polito)
 * Tesi proposte
   - Tutte
     + <p>Identificazione e purificazione di nuove tossine vegetali</p><p>Meccanismi patogenetici del danno cellulare indotto da tossine.</p><p>Immunotossine contenenti anticorpi monoclonali per la terapia sperimentale dei tumori umani.</p><p>&nbsp;</p>
 * Tesi assegnate
 ...
 * Tesi assegnate
   - Tesi di Laurea Magistrale a ciclo unico
     ...
     + Ruolo del ROX index come marker di gravità e outcome dei pazienti con insufficienza respiratoria acuta da COVID-19
   - Tesi di Scuola di Specializzazione
     + La sindrome Post-Covid: prevalenza e impatto a medio-lungo termine nei pazienti dimessi per insufficienza respiratoria acuta da SARS-COV-2 seguiti presso l'ambulatorio pneumologico dedicato dell' UO Pneumologia e Terapia Intensiva Respiratoria - IRCCS Azienda Ospedaliero Universitaria di Bologna.
