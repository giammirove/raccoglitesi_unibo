...
[Sito Web](https://www.unibo.it/sitoweb/elena.bandini7)
 * Tesi proposte
 * Tesi assegnate
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + i reticoli di tamari
     + Il Teorema di Wedderburn per i corpi finiti
     + Matrici ricorsive e successioni polinomiali di tipo intero
   - Tesi di Laurea Magistrale
     + Il calcolo combinatorio nell'insegnamento e nelle Olimpiadi della Matematica
...
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/carolina.beccari2)
 * Tesi proposte
 * Tesi assegnate
 ...
 * Tesi assegnate
   - Tesi di Laurea Magistrale
     ...
     + Il lesson study come strategia di ricerca
...
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/carloalberto.bosello)
 * Tesi proposte
 * Tesi assegnate

#### Andrea Brini
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/andrea.brini)
 * Tesi proposte
 * Tesi assegnate

#### Francesca Brini
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/francesca.brini)
 * Tesi proposte
 * Tesi assegnate
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + I moti rigidi e loro applicazioni alla geometria e all'arte

#### Massimo Campanino
###### Professore ordinario
[Sito Web](https://www.unibo.it/sitoweb/massimo.campanino)
 * Tesi proposte
   - Tutte
     + <p>Rappresentazione stocastica del modello di Ising con campo esterno trasverso.</p><p>Passeggiate aleatorie in ambiente aleatorio.</p><p>Teorema di Glivenko Cantelli.</p><p>Test di Kolmogorov Smirnov.</p><p>&nbsp;</p>
 * Tesi assegnate
   - Tesi di Laurea
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Teoremi di Witt
   - Tesi di Laurea Magistrale
     + Classification of classical Lie superalgebras
...
#### Patrizio Frosini
###### Professore associato
[Sito Web](https://www.unibo.it/sitoweb/patrizio.frosini)
 * Tesi proposte
 * Tesi assegnate

#### Jacopo Gandini
###### Ricercatore a tempo determinato tipo b) (senior)
[Sito Web](https://www.unibo.it/sitoweb/jacopo.gandini)
 * Tesi proposte
 * Tesi assegnate
...
#### Cataldo Grammatico
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/cataldo.grammatico)
 * Tesi proposte
 * Tesi assegnate
 ...
 * Tesi assegnate
   - Tesi di Laurea Magistrale
     ...
     + La Teoria della Calcolabilità nelle scuolesecondarie di secondo grado:Una proposta didattica
     + L'ottimizzazione in due variabili nella scuola secondaria di secondo grado
     + un percorso numerico per la risoluzione di equazioni nella scuola secondaria di secondo grado

#### Alessandro Lanza
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/alessandro.lanza2)
 * Tesi proposte
 * Tesi assegnate

#### Loredana Lanzani
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/loredana.lanzani2)
 * Tesi proposte
 * Tesi assegnate

#### Emanuele Latini
###### Professore associato
[Sito Web](https://www.unibo.it/sitoweb/emanuele.latini)
 * Tesi proposte
 * Tesi assegnate
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Modellazione geometrica mediante curve e superfici
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Sports Tourism
     + tourism policy in turkey andplanning
   - Tesi di Laurea Magistrale
     + Calibration of the Avellaneda-Stoikov market making model in limit order book markets
 ...
 * Tesi assegnate
   - Tesi di Laurea Magistrale
     ...
     + la dimostrazione come oggetto di riflessione

#### Roberta Nibbi
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/roberta.nibbi)
 * Tesi proposte
 * Tesi assegnate

#### Stefano Novellani
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/stefano.novellani)
 * Tesi proposte
 * Tesi assegnate

#### Roberto Pagaria
###### Ricercatore a tempo determinato tipo a) (junior)
[Sito Web](https://www.unibo.it/sitoweb/roberto.pagaria)
 * Tesi proposte
   - Tutte
     + <p>Tesi seguite:</p><ul>    <li>Cohomology of hyperplane and toric arrangements</li>    <li>    <p>Una presentazione dei gruppi delle trecce </p>    </li>    <li>    <p>Spazi di configurazioni su grafi</p>    </li></ul><p>Le possibili proposte riguardano combinatoria, algebra e topologia algebrica a seconda delle preferenze dello studente.<br></p>
 * Tesi assegnate
   - Tesi di Laurea
     + Higher Homotopy Groups and The Whitehead Theorem
     + La Teoria Discreta di Morse
   - Tesi di Laurea Magistrale
     + On the combinatorics and cohomology of Wonderful models for subspace arrangements
     + On the Salvetti Complex for Abelian Arrangements
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Discesa stocastica del gradiente per funzioni non convesse
     + il teorema ergodico e le Monte Carlo Markov Chains
     + Introduzione al Machine Learning e alle reti neurali
     + La metrica di Wasserstein
     + Mean Field Limits For Two-Layer Neural Networks
   ...
   - Tesi di Laurea Magistrale
     ...
     + Tecniche e metodi per le EquazioniDifferenziali Stocastiche diMcKean-Vlasov

#### Davide Palitta
###### Ricercatore a tempo determinato tipo a) (junior)
[Sito Web](https://www.unibo.it/sitoweb/davide.palitta)
 * Tesi proposte
 * Tesi assegnate
...
#### Andrea Pascucci
###### Professore ordinario
[Sito Web](https://www.unibo.it/sitoweb/andrea.pascucci)
 * Tesi proposte
   - Tutte
     + <p>L'elenco delle tesi assegnate in passato è disponibile sul sito di <strong><a href="http://amslaurea.cib.unibo.it/cgi/search/simple?q=pascucci&amp;_action_search=Search&amp;_action_search=Search&amp;_order=bytitle&amp;basic_srchtype=ALL&amp;_satisfyall=ALL">AlmaDL - Unibo</a></strong></p><br><p><strong>Informazioni generali</strong></p><p><strong>Laurea triennale in Matematica</strong></p><p>L'attività di tesi è legata ai temi introdotti nei corsi di </p><p><em>Probabilistà e Statistica Matematica</em></p><br><p><strong>Laurea magistrale in Matematica</strong></p><p>L'attività di tesi è legata ai temi introdotti nei corsi di </p><p><em>Analisi 1 Stocastica</em></p><p><em>Analisi 2 Stocastica</em></p><p>e può avere un contenuto:</p><p>1) <strong>matematico generale</strong>: si inquadra nella teoria delle</p><p> - equazioni differenziali stocastiche: in particolare, problemi di arresto ottimo, processi di Lévy, calcolo di Malliavin;</p><p> - equazioni differenziali del second'ordine ellittico-paraboliche: in particolare equazioni degeneri di tipo Kolmogorov, problemi a frontiera libera, equazioni integro-differenziali.</p><p>2) <strong>matematico applicato</strong>: deep learning, metodi di approssimazione numerica, formule asintotiche, valutazione di derivati Europei ed Americani, mercati dell'energia, modelli per i tassi di interesse.</p><p>Per i temi più applicativi è richiesta una conoscenza di programmazione in Matlab o Mathematica.</p><p>3) <strong>storico</strong>: sullo sviluppo delle teorie del moto Browniano, a partire da L. Bachelier, A. Einsten, N. Wiener, A. Kolmogorov, fino alla formalizzazione del calcolo differenziale stocastico.</p><br>
 * Tesi assegnate
   - Tesi di Laurea
 ...
 * Tesi assegnate
   - Tesi di Laurea Magistrale
     ...
     + Inference approaches for the asymmetric Kinetic Ising Model

#### Maria Carla Tesi
###### Professoressa associata
[Sito Web](https://www.unibo.it/sitoweb/mariacarla.tesi)
 * Tesi proposte
   - Tutte
     + <p>TESI DI LAUREA MAGISTRALE:</p><p>- Modelli matematici per lo studio dell'insorgenza ed evoluzione della malattia di Alzheimer, in collaborazione con la&nbsp;Prof.ssa Germana Landi.</p><p>- Modelli matematici nell'ambito delle scienze biomediche, in particolare nel campo delle neuroscienze.</p><p>TESI DI LAUREA TRIENNALE:</p><p>- Semplici modelli matematici nell'ambito delle scienze biomediche.</p><p>- Teorema di Dini ed applicazione alla teoria delle biforcazioni.</p><p><br><br></p>
 * Tesi assegnate
   - Tesi di Laurea
     + Alcuni modelli matematici per le pandemie.
     + Un modello matematico per i ritmi biologici dell’ippocampo
   - Tesi di Laurea Magistrale
     + Un modello per l'elettrodiffusione ionica e l'osmosi nel parenchima cerebrale

#### Silvia Tozza
###### Ricercatrice a tempo determinato tipo b) (senior)
[Sito Web](https://www.unibo.it/sitoweb/silvia.tozza)
 * Tesi proposte
 * Tesi assegnate

#### Francesco Uguzzoni
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/francesco.uguzzoni)
 * Tesi proposte
 * Tesi assegnate

#### Eugenio Vecchi
###### Ricercatore a tempo determinato tipo b) (senior)
[Sito Web](https://www.unibo.it/sitoweb/eugenio.vecchi2)
 * Tesi proposte
 * Tesi assegnate

#### Sergio Venturini
###### Foto  non disponibile
[Sito Web](https://www.unibo.it/sitoweb/sergio.venturini)
 * Tesi proposte
 * Tesi assegnate
