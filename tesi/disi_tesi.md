## Tesi Informatica - Scienza e Ingegneria - DISI
#### Roberto Amadini
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Sviluppo e Supporto Runtime di Applicazioni Distribuite basate su Framework Koa.js
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Deep Learning in ambito medico e nell’analisi del tumore alla prostata
     + Il sistema di guida autonoma di Tesla
     + Implementazione di un Sistema di Odometria Visiva Monoculare
     + Realtà aumentata: una visione dal suo passato agli utilizzi odierni
     + Sistema per il rilevamento di movimento e riconoscimento di oggetti
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + e-HealthProgetti di integrazione e distribuzione di informazioni in ambito sanitario
     + Fascicolo Sanitario Elettronico: Presente e Futuro
     + Implementazione in linguaggio C++ in versione ottimizzata del tool Reconstruction and Visualization from a Single Projection (ReViSP)
     + studio e sperimentazione di tecniche di valutazione della significatività statistica in modelli nlp
   - Tesi di Laurea Magistrale
     + Studio e progettazione di modelli di raccomandazione di learning paths e di risorse didattiche.
...
#### Roberto Casadei
###### Ricercatore a tempo determinato tipo a) (junior)
[Sito Web](https://www.unibo.it/sitoweb/roby.casadei)
 * Tesi proposte
   - Tutte
     + <p><a href="http://robertocasadei.github.io">Visionare il sito del docente</a>&nbsp;per ulteriori informazioni.</p><p>Si propongono tesi attorno alle seguenti tematiche:</p><ul>    <li>linguaggi di programmazione e paradigmi</li>    <li>sistemi distribuiti e multi-agente</li></ul><p>Esempi includono:</p><ul>    <li>rassegne di linguaggi per la programmazione di sistemi adattativi collettivi e auto-organizzanti;</li>    <li>estensioni a framework per la programmazione aggregata (come <a href="https://scafi.github.io">ScaFi</a>)</li>    <li>esperimenti su algoritmi distribuiti con tecniche innovative&nbsp;</li></ul><p>&nbsp;</p>
 * Tesi assegnate
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Analisi e design di una applicazione web per la realizzazione e l'esecuzione di programmi da remoto
     + Review, analysis e study of some approaches based on Machine Learning in the context of Process Discovery
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Reconnaissance Blind Chess - Intelligenza Artificiale nei giochi a informazione imperfetta
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Neural networks in the reconstruction of 3D topographic images
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Problemi di antitrust relativi alle grandi potenze del web (GAFAM): dall’evoluzione storica alla risposta al COVID-19 ed eventuali futuri sviluppi
     + Si può ancora pescare nel grande oceano di attività di oggi?Presentazione di un caso studio
   - Tesi di Laurea Magistrale
     + GDPR: considerazioni sul grado di applicabilità e di utilità nelcontesto di piccola impresa
     + una valutazione eticadelle agende digitali europee:punti chiave, risultati e lacune
 ...
 * Tesi assegnate
   - Tesi di Laurea Magistrale
     ...
     + Architectural analysis of a CISCO SD-Access network secured with ISE in an industrial environment
     ...
     + Automated testing of PLC control applications through industrial network protocols
     + Detection di attacchi DoS su reti SDN con tecniche di Machine Learning
     + Firma elettronica avanzata tramite CIE 3.0
     + GDPR e Blockchain: analisi degli impatti del Regolamento sulla tecnologia e soluzioni tecniche che ne favoriscono l’adeguamento
     + Individuazione di vulnerabilità nelle librerie di terze parti in applicazioni Android e iOS

#### Danilo Montesi
###### Professore ordinario
[Sito Web](https://www.unibo.it/sitoweb/danilo.montesi)
 * Tesi proposte
   - Tutte
     + <p>Below a partial list of thesis and internships. Please talk to me during office hours for more details. Here are some instructions for writing essays, internships and thesis http://smartdata.cs.unibo.it/internships-thesis (work in progress).</p><p><strong>Available thesis (and internships)</strong></p><p><strong>1. Biomedical/socio-clinical data analysis</strong></p><ul>    <li>    <p>Data mining of clinical data for the prediction of serious unexpected events</p>    </li>    <li>    <p>Clinical predictions using heterogeneous data of patients (text, codes, parameters)</p>    </li>    <li>    <p>Frailty index computation using Machine Learning</p>    </li>    <li>    <p>PubMed full-text dataset crawling and scraping</p>    </li></ul><p><strong>2. Temporal Information Retrieval and Mining</strong></p><ul>    <li>    <p>Tree index for access and search of time intervals in text</p>    </li>    <li>    <p>Evaluation of Temporal Word Embeddings in web archives for text classification</p>    </li></ul><p><strong>3. Text Mining</strong></p><ul>    <li>    <p>Text classification in the International Classification of Diseases (ICD-9, ICD-10) for Emergency Department diagnosis</p>    </li>    <li>    <p>Domain-specific word embeddings for ICD (semi)automatic coding of discharge texts</p>    </li></ul><p><strong>4. Cloud/social networks/digital forensics</strong></p><ul>    <li>    <p>Data exploration tool for investigating social networks of crime-involved subjects</p>    </li>    <li>    <p>Text, pictures and sensors digital footprints analysis</p>    </li></ul><p><strong>5. Copyright and watermarking</strong></p><ul>    <li>    <p>Text authorship attribution by learning characterizing features of writing styles from big datasets</p>    </li>    <li>    <p>Text watermarking and digital rights management for copyright protection</p>    </li>    <li>    <p>Fake news tracking using watermarking to certify the source reliability</p>    </li></ul><p><strong>6. Competition in Digital markets</strong></p><ul>    <li>    <p>competition among service/app providers in the digital markets</p>    </li>    <li>    <p>data portability/open access as technical solution to foster competition</p>    </li>    <li>    <p>online search engine ranking and competition alteration</p>    </li>    <li>    <p>mobile app stores and competition</p>    </li>    <li>    <p>cloud interoperability and competition</p>    </li>    <li>    <p>artificial intelligence and competition </p>    </li></ul><p><strong>7. Similarity distances for plagiarism detection in</strong></p><ul>    <li>    <p>source code</p>    </li>    <li>    <p>text</p>    </li>    <li>    <p>numbers</p>    </li>    <li>    <p>images</p>    </li>    <li>    <p>video</p>    </li>    <li>    <p>audio</p>    </li>    <li>    <p>user experience (human-computer interaction + graphical aspects)</p>    </li></ul><p><strong>8.&nbsp;Interpretability and Explainability in AI using</strong></p><ul>    <li><strong>&nbsp;</strong><span style="font-size: 12.8px;">neural networks</span></li></ul><ul>    <li><span style="font-size: 12.8px;">machine learning</span></li></ul><p>&nbsp;</p>
 * Tesi assegnate
   - Tesi di Laurea
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Classificazione immagini con il framework Windsurf: realizzazione indicizzazione
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Big data stream: valutazione di algoritmi di clustering con il framework MOA
     ...
     + Valutazione della tecnica SMOTE nella classificazione sbilanciata di testi per la previsione automatica della personalità
...
#### Catia Prandi
###### Ricercatrice a tempo determinato tipo b) (senior)
[Sito Web](https://www.unibo.it/sitoweb/catia.prandi2)
 * Tesi proposte
   - Tutte
     + <br><p>Lista <strong>tesi di progetto</strong>:<br></p><ul>    <li>Tesi in collaborazione con il dipartimento di Biologia, all’interno di un progetto finanziato a livello europeo, per la creazione di una web app che permetta di aumentare la consapevolezza delle persone su insetti impollinatori e piante, e monitorare la biodiversità – <strong>Keywords</strong>: web app, gamification, co-design, questionario interattivo</li>    <li>Tesi in collaborazione con l’Università di Bologna, per la creazione di una dashboard di Data Visualization basata su Mappa, per visualizzare dati di inquinamento ambientali collezionati tramite AlmaBike – <strong>Keywords</strong>: tecnologie web, data visualization, dashboard interattiva</li>    <li>Tesi in collaborazione con Università Tedesca per la visualizzazione di dati sull’inquinamento sonoro, su mappa e tramite altri grafici – <strong>Keywords</strong>: data visualization, map-based visualizatation, web tencologies</li>    <li>Tesi relativa ai processi di dematerializzazione per migliorare la sostenibilità dell’Università di Bologna. Sviluppo di app mobile (ibrida o nativa) per la «raccolta» dati outdoor (QR-code, beacons, ecc.) e interazione con display pubblici tramite comunicazione a corto raggio – <strong>Keywords</strong>: mobile app, QR-code, beacons, public display</li>    <li>Tesi per la Sonificazione (presentazioni di dati tramite suono) di dati sull’inquinamento, considerando dati ambientali forniti da API esterne – <strong>Keyworks</strong>: sonification, web app / web technologies, external data</li>    <li>Tesi nel costesto di wayfinding indoor e outdoor per il nuovo complesso Universitario di Bologna, web con integrazione mobile. Collaborazione con l'Università di Bologna, settore AUTC<strong> - Keyworks: </strong>wayfinding, SVG, mappe, percorsi, mobile, front-end<br>    </li>    <li>Varie tesi in ambito mobile (e web) in collaborazione con la collega Prof.ssa Silvia Mirri (mandare email per maggiori info).</li>    <li>Tesi nel contesto mobile e sostenibilità / ambiente,    <ul>        <li>        <p> machine learning per il riconoscimento dei rifiuti in spiaggia - con possibilità di fornire ecofeedback </p>        </li>        <li>        <p>crowdsourcing di “rumore” per capire se la zona ha inquinamento sonoro e crowdsourcing della luminosità dell’area<br>        </p>        </li>    </ul>    <br>    </li>    <li>App mobile con sonificazione nel contesto dell’utilizzo dello smartphone e dell’attività salutare (digital Wellbeing) / di fitness per creare consapevolezza</li></ul><p>&nbsp;</p><p>Collaborazioni con aziende, startup e spin-off.<br></p><ul>    <li><strong></strong>Tirocini e tesi in collaborazione con DEVELOP PLAYERS, spin-off co-partecipata dell’Università di Bologna, che si occupano di creare serious game nel contesto dei disturbi dell’apprendimento (https://www.develop-players.org/ ). In questo caso il Tirocinio è in azienda, occorre proprio applicare usando la piattaforma dei tirocini unibo – <strong>Keywords</strong>: unity, webGL, serious game, gamification, tirocinio in azienda</li>    <li>Tirocinio e tesi (anche compilative) in collaborazione con Food Hub SRL Società Benefit e startup innovativa. L'obiettivo è effettuare uno studio di fattibilità sullo sviluppo di una piattaforma di e- learning personalizzata basata su Moodle. <strong>Keywords</strong>: e-learning, CSS, moodle, PHP.<br>    </li></ul><p><br></p><p>La lista è in continuo aggiornamento. Consiglio quindi sempre di mandare un'email per richiedere informazioni. </p><p>Tutte le proposte di tesi possono essere svolte in modo più corposo ed innovativo considerando studenti di laurea Magistrale e/o diventare tirocinio interno + tesi.<br></p><p>Nel caso di interesse in tesi compilative (triennale), richiedere informazioni mandando direttamente un'email.<br></p><p><em>Lista aggiornata al: 12 Maggio 2022.</em></p>
 * Tesi assegnate
   - Tesi di Laurea
     + AI e IoT: contesto e stato dell’arte
     + Applicazione della gamification per la tracciabilità del miele nel contesto del progetto europeo BeePathNet
     + Applicazioni della blockchain nel contesto della sostenibilità
     + AR VR e interfacce aptiche: stato dell'arte e sfide future
     + Blockchain e Human Computer Interaction
     + Citizen science e biodiversità: un’app per il monitoraggio del Mediterraneo
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Nuovi modelli di business nel Web 3.0
     + Sicurezza dell'identità digitale e videogiocatori
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + COVIDBOT - chatbot intelligente a servizio del cittadino durante la pandemia
   - Tesi di Laurea Magistrale
     + A study of Machine Learning Techniques for Multi-Floor Indoor Localization using Wifi Fingerprinting
     + Analisi e realizzazione del processo di migrazione di un Data Warehouse
     + Analysis of LinkedIn profiles with Machine Learning techniques
     + Automation in customer service: a text mining application for classification and management of technical support tickets
     + BlenderBot 2.0: Studio e Modellazione di un Chatbot basato su Transformers
     + Cluster analysis su dati di origine ambientale
     + Deep Generative Models with Probabilistic Logic Priors
     + Development and optimization of a tool for Face Mask Detection in streaming video
     + ENGINE – ENel Global INtellingent Engine
     + Forecasting Intermittent Demand: A Comparative Approach
     + Implementazione di processi di rendicontazione in ambiente SAP BW/4HANA
     + Information Usefulness To Support Dialogue Management in Healthcare
     + Ottimizzazione del carico di un mezzo di trasporto: analisi, progettazione e sviluppo di algoritmi
     + Quantum Machine Learning: Development and Evaluation of the Multiple Aggregator Quantum Algorithm
     + Rilevamento delle manipolazioni nelle immagini digitali con tecniche di Deep Learning
     + Sviluppo di una libreria per la visualizzazione di dati spazio temporali in R
     + Tecniche di profilazione di utenti web nel mondo fitness
...
#### Giancarlo Succi
###### Professore ordinario
[Sito Web](https://www.unibo.it/sitoweb/giancarlo.succi2)
 * Tesi proposte
 * Tesi assegnate

#### Giuseppe Tagliavini
###### Ricercatore a tempo determinato tipo a) (junior)
[Sito Web](https://www.unibo.it/sitoweb/giuseppe.tagliavini)
 * Tesi proposte
 * Tesi assegnate
 ...
 * Tesi assegnate
   - Tesi di Laurea Magistrale
     ...
     + A Transformer-Based Application For Researchers Recommendation
     ...
     + Design and characterization of a Three-axis accelerometer system for swingarm and fork applications with automatic temperature compensation
     + Design and implementation of a real-world search engine based on Okapi BM25 and SentenceBERT
     + Development of a conversational AI system with LUIS: a case study in the media & telecommunications sector
     ...
     + PSW DLL generator: an automatic code generation tool for motorsport simulations and analysis
 ...
 * Tesi proposte
   - Tutte
     + Sono disponibili varie Tesi di Laurea "Triennale" e "Magistrale": gli studenti possono&nbsp; discuterle col docente a ricevimento. Gli argomenti generali sono (in Inglese):<ul>    <li>Systems development with advanced Java-based tools/techniques for Software Engineering</li>    <li>Experiments/development with Scala programming language and frameworks</li>    <li>Experiments/development with IoT systems: mobile, embedded and cloud frameworks</li>    <li>Design of innovative self-organising large-scale systems (drones, collective wearable devices, etc.)</li>    <li>Software Engineering for business applications</li>    <li>Research in Aggregate Computing (tools, libraries, frameworks)</li></ul>
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Prototipazione di applicazioni collaborative e distribuite per schermi Touch
     + ScaFi: Integration and Performance Analysis with Scala Native
   - Tesi di Laurea Magistrale
     + Sistemi distribuiti di illuminazione intelligente per domotica aziendale
     + Sviluppo di un progetto di UI automation testing con approccio BDD e gestione delle CI/CD pipelines
 ...
 * Tesi assegnate
   - Tesi di Laurea
     ...
     + Architetture basate su configurazione nei frameworkmoderni per il web
     + DRING Studio e Realizzazione di un Citofono Smart
     + Esprimere incertezza, ipotesi, dubbi in RDF con le Congetture
     + Porting di una applicazione web da monolitica a component-based
     + Redesign and implementation of an Akoma-Ntoso based web editor for the markup of legal documents
     + Sviluppo di un editor di metadati per Simplex
     + Trasformazione di una web application in una progressive web app e classificazione delle sue tecnologie
   - Tesi di Laurea Magistrale
     + A design approach for sighted programmers developing accessible Web content
     + Approcci recenti alla valutazione di user experience e usabilità
     + Expressing BroadcastingA database model for broadcasting to express the opinions, characteristics and history of a media through RDF
     + From Software Engineering to Software Reuse: possibly reusable components in Kikeroo
     + Incorporating trust in user experience design to remove purchase decision obstacles: The example of Chrono24
     + The importance of cultural identity in the digital era case study: Cameroon
     + The transmission of literary heritage between play and wonder. The UX study and UI design of an interactive technological environment aimed at promoting the fruition of the Orlando Furioso towards a children audience: Furiose Interazioni’s atelier project.
     + Typographic layout in history and the problem of automatic identification of rivers
     + University and Research Services: Usability Evaluation and Design Proposal of U-Web Missioni Tool By Cineca
